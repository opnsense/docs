...
--------------
Add failover PPPoE WAN Interface on top of CARP-Interface
--------------
Requirement:
 * Working WANBASE (DSLMODEM) Interface with CARP IP
 * Working PPPoE (WAN) Interface on top of WANBASE (DSLMODEM)

In this case you have working PPPoE Failover and can make maintenance like in :ref:`Example: Updating a CARP HA Cluster`
