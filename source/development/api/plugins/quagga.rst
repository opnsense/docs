...
.. csv-table:: Resources (OspfsettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``POST``","quagga","ospfsettings","add_area",""
    ...
    "``POST``","quagga","ospfsettings","del_area","$uuid"
    ...
    "``GET``","quagga","ospfsettings","get_area","$uuid=null"
    ...
    "``GET,POST``","quagga","ospfsettings","search_area",""
    ...
    "``POST``","quagga","ospfsettings","set_area","$uuid"
    ...
    "``POST``","quagga","ospfsettings","toggle_area","$uuid"
