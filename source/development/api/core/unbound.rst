...
.. csv-table:: Resources (DiagnosticsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``POST``","unbound","diagnostics","test_blocklist",""
...
.. csv-table:: Resources (SettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``POST``","unbound","settings","add_dnsbl",""
    ...
    "``POST``","unbound","settings","del_dnsbl","$uuid"
    ...
    "``GET``","unbound","settings","get_dnsbl","$uuid=null"
    ...
    "``GET,POST``","unbound","settings","search_dnsbl",""
    ...
    "``POST``","unbound","settings","set_dnsbl","$uuid"
    ...
    "``POST``","unbound","settings","toggle_dnsbl","$uuid,$enabled=null"
