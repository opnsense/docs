...
* plugins: os-zabbix-proxy1.13 `[2] <https://github.com/opnsense/plugins/blob/stable/25.1/net-mgmt/zabbix-proxy/pkg-descr>`__ 
...
* plugins: os-haproxy 4.6 `[1] <https://github.com/opnsense/plugins/blob/stable/net/haproxy/pkg-descr>`__ 
