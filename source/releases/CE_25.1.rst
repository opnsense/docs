...
* ports: libxml 2.14.5 `[1] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.14.5/NEWS>`__ 
* ports: sqlite SONAME fix and associated rebuilds `[2] <https://github.com/freebsd/freebsd-ports/commit/25ef3857b8>`__ 
...
* ports: libxml 2.14.4 `[7] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.14.4/NEWS>`__ 
...
* ports: sudo 1.9.17p1 `[12] <https://www.sudo.ws/releases/stable/#1.9.17p1>`__ 
...
* ports: libxml fixes for recent CVEs
...
* ports: sudo 1.9.17 `[4] <https://www.sudo.ws/releases/stable/#1.9.17>`__ 
...
* ports: openldap 2.6.10 `[4] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
but take note that libxml is currently stuck in an old release in
...
* ports: kea 2.6.3 `[4] <https://gitlab.isc.org/isc-projects/kea/-/wikis/Release-Notes/release-notes-2.6.3>`__ 
...
* interfaces: improve private and bogon network filters (contributed by Maurice Walker)
...
* ports: kea 2.6.2 `[5] <https://gitlab.isc.org/isc-projects/kea/-/wikis/Release-Notes/release-notes-2.6.2>`__ 
...
* ports: openvpn 2.6.14 `[3] <https://github.com/OpenVPN/openvpn/blob/v2.6.14/Changes.rst>`__ 
...
* ports: openvpn 2.6.13 `[8] <https://github.com/OpenVPN/openvpn/blob/v2.6.13/Changes.rst>`__ 
...
* ports: openvpn 2.6.13 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.6.13/Changes.rst>`__ 
