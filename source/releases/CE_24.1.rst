...
* ports: krb5 1.21.3 `[7] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: openvpn 2.6.11 `[10] <https://github.com/OpenVPN/openvpn/blob/v2.6.11/Changes.rst>`__ 
...
* ports: openldap 2.6.8 `[4] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: libxml 2.11.8 `[3] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.11.8/NEWS>`__ 
...
* firewall: fix visible rows quantity off-by-one (contributed by NOYB)
...
* ports: openvpn 2.6.10 `[8] <https://github.com/OpenVPN/openvpn/blob/v2.6.10/Changes.rst>`__ 
...
* ports: libpfctl 0.9
* ports: libxml 2.11.7 `[3] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.11.7/NEWS>`__ 
...
* ports: openvpn 2.6.9 `[9] <https://github.com/OpenVPN/openvpn/blob/v2.6.9/Changes.rst>`__ 
...
* ports: openldap 2.6.7 `[5] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: libxml 2.11.6 `[5] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.11.6/NEWS>`__ 
...
* ports: libxml 2.11.6 `[2] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.11.6/NEWS>`__ 
