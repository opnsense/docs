...
* ports: openvpn 2.6.5 `[13] <https://github.com/OpenVPN/openvpn/blob/v2.6.5/Changes.rst>`__ 
...
* ports: krb5 1.21.2 `[20] <https://web.mit.edu/kerberos/krb5-1.21/>`__ 
* ports: python 3.9.18 `[21] <https://docs.python.org/release/3.9.18/whatsnew/changelog.html>`__ 
...
* ports: libxml 2.10.4 `[11] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.10.4/NEWS>`__ 
...
* ports: openvpn 2.6.4 `[15] <https://github.com/OpenVPN/openvpn/blob/v2.6.4/Changes.rst>`__ 
...
* ports: openldap 2.6.4 `[23] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: sudo 1.9.13p3 `[31] <https://www.sudo.ws/releases/stable/#1.9.13p3>`__ 
