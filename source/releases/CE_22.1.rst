...
* ports: sudo 1.9.11p3 `[9] <https://www.sudo.ws/releases/stable/#1.9.11p3>`__ 
...
* ports: openvpn 2.5.7 `[8] <https://github.com/OpenVPN/openvpn/blob/v2.5.7/Changes.rst>`__ 
...
* ports: sudo 1.9.11p2 `[11] <https://www.sudo.ws/releases/stable/#1.9.11p2>`__ 
...
* unbound: fix overrides case sort order (contributed by NOYB)
...
* ports: libxml 2.9.13 `[12] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.9.13/NEWS>`__ 
...
* ports: openvpn 2.5.6 `[6] <https://github.com/OpenVPN/openvpn/blob/v2.5.6/Changes.rst>`__ 
...
* ports: krb5 1.19.3 `[5] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: sudo 1.9.10 `[8] <https://www.sudo.ws/releases/stable/#1.9.10>`__ 
...
* ports: sudo 1.9.9 `[15] <https://www.sudo.ws/releases/stable/#1.9.9>`__ 
...
* ports: openvpn 2.5.5 `[19] <https://github.com/OpenVPN/openvpn/blob/v2.5.5/Changes.rst>`__ 
...
* ports: pkg fixes validation failures on HTTPS fetch in static binary `[23] <https://github.com/freebsd/freebsd-ports/commit/08342c9812d>`__ 
...
* ports: pkg fixes validation failures on HTTPS fetch in static binary `[6] <https://github.com/freebsd/freebsd-ports/commit/08342c9812d>`__ 
