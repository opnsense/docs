...
* plugins: os-frr 1.50 `[2] <https://github.com/opnsense/plugins/blob/stable/25.7/net/frr/pkg-descr>`__ 
* plugins: os-ndp-proxy-go 1.3 `[3] <https://github.com/opnsense/plugins/blob/stable/25.7/net/ndp-proxy-go/pkg-descr>`__ 
* plugins: os-telegraf 1.12.14 `[4] <https://github.com/opnsense/plugins/blob/stable/25.7/net/turnserver/pkg-descr>`__ 
* plugins: os-theme-rebellion 1.9.4 (contributed by Team Rebellion)
* plugins: os-turnserver 1.1 `[5] <https://github.com/opnsense/plugins/blob/stable/25.7/net/upnp/pkg-descr>`__ 
* plugins: os-upnp 1.8 features assorted improvements to plugin and daemon (contributed by Self-Hosting-Group)
* plugins: os-zabbix-agent 1.18 `[6] <https://github.com/opnsense/plugins/blob/stable/25.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.16 `[7] <https://github.com/opnsense/plugins/blob/stable/25.7/net-mgmt/zabbix-proxy/pkg-descr>`__ 
...
* src: fix multiple vulnerabilities in OpenSSL `[8] <https://www.freebsd.org/security/advisories/FreeBSD-SA-26:01.openssl.asc>`__ 
* src: jail escape by a privileged user via nullfs `[9] <https://www.freebsd.org/security/advisories/FreeBSD-SA-26:02.jail.asc>`__ 
* src: arm64 SVE signal context misalignment `[10] <https://www.freebsd.org/security/advisories/FreeBSD-EN-26:02.arm64.asc>`__ 
* src: page fault handler fails to zero memory `[11] <https://www.freebsd.org/security/advisories/FreeBSD-EN-26:03.vm.asc>`__ 
* ports: dpinger 3.4 `[12] <https://github.com/dennypage/dpinger/releases/tag/v3.4>`__ 
* ports: filterlog no longer uses unneeded promiscuous mode
* ports: libucl 0.9.3
* ports: libxml 2.15.1 `[13] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.15.1/NEWS>`__ 
* ports: nss 3.119.1 `[14] <https://firefox-source-docs.mozilla.org/security/nss/releases/nss_3_119_1.html>`__ 
* ports: openssl 3.0.19 `[15] <https://github.com/openssl/openssl/blob/openssl-3.0/CHANGES.md>`__ 
...
* ports: kea 3.0.2 `[14] <https://gitlab.isc.org/isc-projects/kea/-/wikis/Release-Notes/release-notes-3.0.2>`__ 
* ports: libxml 2.14.6 `[15] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.14.6/NEWS>`__ 
...
* ports: openvpn 2.6.17 `[18] <https://github.com/OpenVPN/openvpn/blob/v2.6.17/Changes.rst>`__ 
...
* ports: kea 3.0.1 `[26] <https://gitlab.isc.org/isc-projects/kea/-/wikis/Release-Notes/release-notes-3.0.1>`__ 
* ports: krb5 1.22.1 `[27] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
* ports: libpfctl 0.17
...
* ports: openvpn 2.6.15 `[31] <https://github.com/OpenVPN/openvpn/blob/v2.6.15/Changes.rst>`__ 
...
* ports: sudo 1.9.17p2 `[40] <https://www.sudo.ws/releases/stable/#1.9.17p2>`__ 
