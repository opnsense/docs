...
* ports: openldap 2.6.9 `[17] <https://www.openldap.org/software/release/changes_lts.html>`__ 
* ports: openvpn 2.6.13 `[18] <https://github.com/OpenVPN/openvpn/blob/v2.6.13/Changes.rst>`__ 
...
* ports: sudo 1.9.16p2 `[21] <https://www.sudo.ws/releases/stable/#1.9.16p2>`__ 
...
* ports: kea 2.6.1 `[27] <https://gitlab.isc.org/isc-projects/kea/-/wikis/Release-Notes/release-notes-2.6.1>`__ 
* ports: libpfctl 0.13
* ports: libxml 2.11.9 `[28] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.11.9/NEWS>`__ 
...
* ports: openvpn 2.6.12 `[31] <https://github.com/OpenVPN/openvpn/blob/v2.6.12/Changes.rst>`__ 
...
* ports: sudo 1.9.16 `[39] <https://www.sudo.ws/releases/stable/#1.9.16>`__ 
