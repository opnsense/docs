...
* ports: krb5 1.20.1 `[16] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
* ports: libxml 2.10.3 `[17] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.10.3/NEWS>`__ 
...
* ports: openvpn 2.5.8 `[20] <https://github.com/OpenVPN/openvpn/blob/v2.5.8/Changes.rst>`__ 
...
* firewall: add BGP ASN type to aliases `[3] <https://docs.opnsense.org/manual/aliases.html>`__ 
...
* ports: ldns 1.8.3 `[35] <https://github.com/NLnetLabs/ldns/blob/1.8.3/Changelog>`__ 
* ports: liblz4 1.9.4
* ports: libxml 2.10.2 `[36] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.10.2/NEWS>`__ 
...
* ports: sudo 1.9.12p1 `[47] <https://www.sudo.ws/releases/stable/#1.9.12p1>`__ 
