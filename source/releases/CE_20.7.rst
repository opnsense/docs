...
* ports: sudo 1.9.5p1 `[8] <https://www.sudo.ws/releases/stable/#1.9.5p1>`__ 

A hotfix release was issued as 20.7.8_4:

* firmware: enable upgrade path to 21.1
* ports: sudo 1.9.5p2 `[9] <https://www.sudo.ws/releases/stable/#1.9.5p2>`__ 
...
* ports: sudo 1.9.4 `[11] <https://www.sudo.ws/releases/stable/#1.9.4>`__ 
...
* ports: krb5 1.18.3 `[9] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
* ports: nss 3.59 `[10] <https://firefox-source-docs.mozilla.org/security/nss/releases/nss_3_59.html>`__ 
* ports: openldap 2.4.56 `[11] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: sudo 1.9.3p1 `[7] <https://www.sudo.ws/releases/stable/#1.9.3p1>`__ 
...
* ports: openldap 2.4.51 `[7] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: sudo 1.9.2 `[7] <https://www.sudo.ws/releases/stable/#1.9.2>`__ 
