...
* ports: openssl 1.0.2c `[5] <https://www.openssl.org/news/openssl-1.0.2-notes.html>`__ , libressl 2.2.0 `[6] <https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.2.0-relnotes.txt>`__ , php 5.6.10 `[7] <https://www.php.net/ChangeLog-5.php#5.6.10>`__ , dnsmasq 2.73 `[8] <https://www.thekelleys.org.uk/dnsmasq/CHANGELOG>`__ , smartmontools 6.4 `[9] <https://www.smartmontools.org/browser/tags/RELEASE_6_4/smartmontools/NEWS>`__ 
...
* gateways: monitoring via :code:`apinger` is now turned off by default for all new gateways created (opt-out flipped to opt-in for privacy reasons)
...
* users: user with group admins now have :code:`wheel` group associated with them, allowing them to use :code:`su` or :code:`sudo` (if configured)
* users: do not copy root's hidden files while creating a new user home directory
* ports: pcre 8.37_1 `[1] <https://github.com/freebsd/freebsd-ports/commit/030adcf1d>`__ 
* ports: phalcon 2.0.2 `[2] <https://github.com/phalcon/cphalcon/releases/tag/phalcon-v2.0.2>`__ 
* ports: strongswan 5.3.2 `[3] <https://wiki.strongswan.org/projects/strongswan/wiki/Changelog53>`__ 
* ports: sqlite 3.8.10.2 `[4] <https://sqlite.org/releaselog/3_8_10_2.html>`__ 
* ports: openvpn 2.3.7 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.3.7/ChangeLog>`__ 
* ports: openssl 1.0.2b `[6] <http://marc.info/?l=openbsd-announce&m=143404058913441>`__ 
* ports: libressl 2.1.7 `[7] <https://github.com/freebsd/freebsd-ports/commit/40365ab880101ee>`__ 
* ports: pkg 1.5.4 `[8] <https://www.openssl.org/news/secadv_20150611.txt>`__ 
...
* ports: updated to ca_root_nss 3.19, sqlite 3.8.10.1, php 5.6.9 `[6] <https://www.php.net/ChangeLog-5.php#5.6.9>`__ , openssh 6.8p1_7 `[7] <http://www.openwall.com/lists/oss-security/2015/05/16/3>`__ 
...
* openvpn: added Tunnelblick's version of the OpenVPN XOR feature for protocol obfuscation `[3] <https://code.google.com/p/tunnelblick/wiki/cOpenvpn_xorpatch>`__ 
...
* ports: PHP 5.6.8 `[2] <https://www.php.net/ChangeLog-5.php#5.6.8>`__ 
...
* ports: strongswan 5.3.0 `[1] <https://www.strongswan.org/blog/2015/03/30/strongswan-5.3.0-released.html>`__ , openssh 6.8p1 `[2] <https://www.openssh.com/txt/release-6.8>`__ , ntp 4.2.8p2 `[3] <http://support.ntp.org/bin/view/Main/SecurityNotice#Recent_Vulnerabilities>`__ 
...
* core: fixed numerous :code:`Cannot create references to/from string offsets nor overloaded objects` errors related to 15.1.8's config system switch
...
* system settings: finally flipped the SSH key only checkbox to properly align with the underlying settings name of :code:`PasswordAuthentication`
...
* ports: PHP was updated to 5.6.7 addressing CVE-2015-0231, CVE-2015-2305, etc. `[1] <https://www.php.net/ChangeLog-5.php#5.6.7>`__ 
...
* Fix vt(4) crash with improper ioctl parameters `[2] <https://www.freebsd.org/security/advisories/FreeBSD-EN-15:01.vt.asc>`__ 
* Updated base system OpenSSL to 1.0.1l `[3] <https://www.freebsd.org/security/advisories/FreeBSD-EN-15:02.openssl.asc>`__ 
* Fix freebsd-update libraries update ordering issue `[4] <https://www.freebsd.org/security/advisories/FreeBSD-EN-15:03.freebsd-update.asc>`__ 
...
* Notable port updates: pkg 1.4.12, bind 9.9.6-P2 `[2] <https://kb.isc.org/article/AA-01235>`__  (CVE-2015-1349), php 5.6.6 `[3] <https://www.php.net/ChangeLog-5.php#5.6.6>`__  (CVE-2015-0273), syslogd 10.1
...
* Notable ports updates: pkg 1.4.10, gettext 0.19.4, libzmq 4.0.5, ntp 4.2.8p1, ca_root_nss 3.17.4
...
This week we took PHP's stable update `[1] <https://www.php.net/ChangeLog-5.php#5.6.5>`__  as a subtle hint to release another
...
* ports: bind 9.9.6P1
* ports: curl 7.40.0
* ports: libevent 2.0.22
* ports: libffi 3.2.1
* ports: libssh2 1.4.3_5
* ports: pkg 1.4.4
* ports: strongswan 5.2.2
* Added template engine for new features
* Several bug fixes and enhancements `[2] <https://github.com/opnsense/core/issues>`__  (#6, #7, #8, #9, #17, #19, #20, #21, #22, #23)
