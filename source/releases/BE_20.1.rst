...
* ports: krb5 1.18.2 `[11] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: sudo 1.9.1 `[17] <https://www.sudo.ws/releases/stable/#1.9.1>`__ 
...
* ports: openldap 2.4.50 `[8] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: krb5 1.18.1 `[5] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
* ports: openvpn 2.4.9 `[6] <https://github.com/OpenVPN/openvpn/blob/v2.4.9/Changes.rst>`__ 
...
* ports: sudo 1.8.31p1 `[23] <https://www.sudo.ws/releases/legacy/#1.8.31p1>`__ 
...
* ports: openldap 2.4.49 `[5] <https://www.openldap.org/software/release/changes_lts.html>`__ 
* ports: pkg libfetch security fix `[6] <https://github.com/freebsd/freebsd-ports/commit/eec0b5c>`__ 
* ports: sudo 1.8.31 `[7] <https://www.sudo.ws/releases/legacy/#1.8.31>`__ 
...
* To prevent stale configuration files for remote syslog we advise to setup the new targets first `[9] <https://docs.opnsense.org/manual/settingsmenu.html>`__  and disable the old ones under System: Settings: Logging
...
* interfaces: move description into top block and rename titles
