...
* Intrusion detection GeoIP rules are automatically deactivated and need to be manually migrated to firewall alias GeoIP.
* Monit general settings do not save.  A patch exists `[12] <https://docs.opnsense.org/manual/dynamic_routing.html>`__  to remedy this problem: opnsense-patch a2899594
