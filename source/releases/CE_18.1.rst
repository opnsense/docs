...
* ports: php 7.1.19 `[4] <https://www.php.net/ChangeLog-7.php#7.1.19>`__ 
...
* ports: php 7.1.18 `[7] <https://www.php.net/ChangeLog-7.php#7.1.18>`__ 
...
* ports: krb5 1.16.1 `[4] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: sudo 1.8.23 `[8] <https://www.sudo.ws/releases/legacy/#1.8.23>`__ 
...
* ports: openldap 2.4.46 `[3] <https://www.openldap.org/software/release/changes_lts.html>`__ 
* ports: openssh 7.7p1 `[4] <https://www.openssh.com/txt/release-7.7>`__ 
* ports: openvpn 2.4.6 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.4.6/Changes.rst>`__ 
...
* src: ipsec crash or denial of service `[1] <https://www.freebsd.org/security/advisories/FreeBSD-SA-18:05.ipsec.asc>`__ 
* src: vt console memory disclosure `[2] <https://www.freebsd.org/security/advisories/FreeBSD-SA-18:04.vt.asc>`__ 
* src: multiple minor kernel memory disclosures `[3] <https://www.freebsd.org/security/advisories/FreeBSD-EN-18:04.mem.asc>`__ 
* src: timezone database information update `[4] <https://www.freebsd.org/security/advisories/FreeBSD-EN-18:03.tzdata.asc>`__ 
...
* ports: php 7.1.16 `[8] <https://www.php.net/ChangeLog-7.php#7.1.16>`__ 
...
* ports: openvpn 2.4.5 `[9] <https://github.com/OpenVPN/openvpn/blob/v2.4.5/Changes.rst>`__ 
* ports: phalcon 3.3.2 `[10] <https://github.com/phalcon/cphalcon/releases/tag/v3.3.2>`__ 
* ports: php 7.1.15 `[11] <https://www.php.net/ChangeLog-7.php#7.1.15>`__ 
...
* ports: php 7.1.13 `[5] <https://www.php.net/ChangeLog-7.php#7.1.13>`__ 
* ports: sudo 1.8.22 `[6] <https://www.sudo.ws/releases/legacy/#1.8.22>`__ 
