...
* ports: sudo 1.9.11p3 `[6] <https://www.sudo.ws/releases/stable/#1.9.11p3>`__ 
...
* ports: openvpn 2.5.7 `[12] <https://github.com/OpenVPN/openvpn/blob/v2.5.7/Changes.rst>`__ 
...
* ports: sudo 1.9.11p2 `[16] <https://www.sudo.ws/releases/stable/#1.9.11p2>`__ 
...
* plugins: os-OPNcentral 1.5 `[1] <https://docs.opnsense.org/vendor/deciso/opncentral.html>`__ 
...
* firmware: revoke 21.10 fingerprint
...
* plugins: os-OPNProxy 1.0.1 `[2] <https://docs.opnsense.org/vendor/deciso/opnproxy.html>`__ 
...
* ports: krb5 1.19.3 `[26] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: openvpn 2.5.6 `[32] <https://github.com/OpenVPN/openvpn/blob/v2.5.6/Changes.rst>`__ 
...
* ports: pkg fixes validation failures on HTTPS fetch in static binary `[37] <https://github.com/freebsd/freebsd-ports/commit/08342c9812d>`__ 
* ports: sudo 1.9.10 `[38] <https://www.sudo.ws/releases/stable/#1.9.10>`__ 
