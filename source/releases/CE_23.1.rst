...
* ports: openvpn 2.6.5 `[8] <https://github.com/OpenVPN/openvpn/blob/v2.6.5/Changes.rst>`__ 
...
* ports: openvpn 2.6.4 `[6] <https://github.com/OpenVPN/openvpn/blob/v2.6.4/Changes.rst>`__ 
...
* ports: libxml 2.10.4 `[2] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.10.4/NEWS>`__ 
* ports: openvpn 2.6.3 `[3] <https://github.com/OpenVPN/openvpn/blob/v2.6.3/Changes.rst>`__ 
...
* firewall: allow to create aliases for logged-in OpenVPN users `[1] <https://docs.opnsense.org/manual/aliases.html>`__ 
...
* ports: sudo 1.9.13p3 `[2] <https://www.sudo.ws/releases/stable/#1.9.13p3>`__ 
...
* ports: openldap 2.6.4 `[8] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: sudo 1.9.13p2 `[14] <https://www.sudo.ws/releases/stable/#1.9.13p2>`__ 
...
* ports: sudo 1.9.12p2 `[12] <https://www.sudo.ws/releases/stable/#1.9.12p2>`__ 
