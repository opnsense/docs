...
* plugins: os-caddy 2.0.4 `[1] <https://github.com/opnsense/plugins/blob/stable/25.7/www/caddy/pkg-descr>`__ 
...
* plugins: os-zabbix-agent 1.17 `[2] <https://github.com/opnsense/plugins/blob/stable/25.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.14 `[3] <https://github.com/opnsense/plugins/blob/stable/25.7/net-mgmt/zabbix-proxy/pkg-descr>`__ 
* ports: dnspython 2.8.0 `[4] <https://dnspython.readthedocs.io/en/stable/whatsnew.html>`__ 
* ports: kea 3.0.1 `[5] <https://downloads.isc.org/isc/kea/3.0.1/Kea-3.0.1-ReleaseNotes.txt>`__ 
* ports: libpfctl 0.17
* ports: lighttpd 1.4.82 `[6] <https://www.lighttpd.net/2025/9/12/1.4.82/>`__ 
* ports: nss 3.116 `[7] <https://firefox-source-docs.mozilla.org/security/nss/releases/nss_3_116.html>`__ 
* ports: openvpn 2.6.15 `[8] <https://community.openvpn.net/openvpn/wiki/ChangesInOpenvpn26#Changesin2.6.15>`__ 
* ports: php 8.3.26 `[9] <https://www.php.net/ChangeLog-8.php#8.3.26>`__ 
* ports: py-requests 2.32.5
* ports: suricata 7.0.12 `[10] <https://suricata.io/2025/09/16/suricata-8-0-1-and-7-0-12-released/>`__ 
* ports: unbound 1.24.0 `[11] <https://nlnetlabs.nl/projects/unbound/download/#unbound-1-24-0>`__ 
