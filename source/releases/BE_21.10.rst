...
* plugins: os-OPNcentral 1.4 adds improved provisioning to allow unique local content `[23] <https://docs.opnsense.org/vendor/deciso/opncentral.html>`__ 
...
* ports: openvpn 2.5.4 `[22] <https://github.com/OpenVPN/openvpn/blob/v2.5.4/Changes.rst>`__ 
...
* ports: sudo 1.9.8p2 `[28] <https://www.sudo.ws/releases/stable/#1.9.8p2>`__ 
...
* firmware: revoke 21.4 fingerprint
...
* ports: ifinfo 13.0
* ports: krb5 1.19.2 `[20] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: openvpn 2.5.3 `[23] <https://github.com/OpenVPN/openvpn/blob/v2.5.3/Changes.rst>`__ 
...
* ports: sudo 1.9.8p1 `[29] <https://www.sudo.ws/releases/stable/#1.9.8p1>`__ 
