...
* ports: sudo 1.8.30 `[14] <https://www.sudo.ws/releases/legacy/#1.8.30>`__ 
...
* ports: openvpn 2.4.8 `[10] <https://github.com/OpenVPN/openvpn/blob/v2.4.8/Changes.rst>`__ 
...
* ports: sudo 1.8.29 `[6] <https://www.sudo.ws/releases/legacy/#1.8.29>`__ 
...
* ports: ldns 1.7.1 `[5] <https://github.com/NLnetLabs/ldns/blob/release-1.7.1/Changelog>`__ 
...
* src: fix insufficient validation of guest-supplied data on the e1000 device `[11] <https://www.freebsd.org/security/advisories/FreeBSD-SA-19:21.bhyve.asc>`__ 
...
* ports: openldap 2.4.48 `[17] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: syslog-ng 3.22.1 `[21] <https://github.com/syslog-ng/syslog-ng/releases/tag/syslog-ng-3.22.1>`__ 
...
* ports: libevent 2.1.11 `[12] <https://github.com/libevent/libevent/releases/tag/release-2.1.11-stable>`__ 
...
* system: default gateway switching priority control `[2] <https://www.max-it.de/>`__  (sponsored by m.a.x. it)
...
* ports: syslog-ng 3.21.1 `[5] <https://github.com/syslog-ng/syslog-ng/releases/tag/syslog-ng-3.21.1>`__ 
