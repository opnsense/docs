...
* ports: sudo 1.8.19p2 `[6] <https://www.sudo.ws/releases/legacy/#1.8.19p2>`__ 
* ports: lighttpd 1.4.45 `[7] <https://www.lighttpd.net/2017/1/14/1.4.45/>`__ 
* ports: php 5.6.30 `[8] <https://www.php.net/ChangeLog-5.php#5.6.30>`__ 
...
* ports: sudo 1.8.19p1 `[2] <https://www.sudo.ws/releases/legacy/#1.8.18p1>`__ 
...
* ports: openvpn 2.3.14 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.3.14/Changes.rst>`__ 
...
* ports: openvpn 2.3.13 `[10] <https://github.com/OpenVPN/openvpn/blob/v2.3.13/Changes.rst>`__ 
* ports: pecl-radius 1.4.0b1 `[11] <https://pecl.php.net/package-changelog.php?package=radius&release=1.4.0b1>`__ 
* ports: php 5.6.28 `[12] <https://www.php.net/ChangeLog-5.php#5.6.28>`__ 
* ports: sudo 1.8.18p1 `[13] <https://www.sudo.ws/releases/legacy/#1.8.18p1>`__ 
...
* ports: php 5.6.27 `[3] <https://www.php.net/ChangeLog-5.php#5.6.27>`__ 
...
* firmware: new mirror in Serbia `[1] <https://fourdots.com/>`__  (contributed by FourDots)
...
* ports: curl 7.50.3 `[1] <https://curl.haxx.se/mail/lib-2016-09/0040.html>`__ , sudo 1.8.18 `[2] <https://www.sudo.ws/releases/legacy/#1.8.18>`__ , php 5.6.26 `[3] <https://www.php.net/ChangeLog-5.php#5.6.26>`__ , openssl 1.0.2j `[4] <https://www.openssl.org/news/secadv/20160922.txt>`__  `[5] <https://www.openssl.org/news/secadv/20160926.txt>`__ 
...
* ports: haproxy 1.6.9 `[1] <http://www.haproxy.org/download/1.6/src/CHANGELOG>`__ , hyperscan 4.3.1 `[2] <https://github.com/intel/hyperscan/releases/tag/v4.3.1>`__ , suricata 3.1.2 `[3] <https://suricata-ids.org/2016/09/07/suricata-3-1-2-released/>`__ , phalcon 3.0.1 `[4] <https://github.com/phalcon/cphalcon/releases/tag/v3.0.1>`__ , samplicator 1.3.8rc1
...
* ports: php 5.6.25 `[2] <https://www.php.net/ChangeLog-5.php#5.6.25>`__ 
* ports: sqlite 3.14.1 `[3] <https://sqlite.org/releaselog/3_14_1.html>`__ 
* ports: openvpn 2.3.12 `[4] <https://github.com/OpenVPN/openvpn/blob/v2.3.12/Changes.rst>`__ 
* ports: libxml 2.9.4 `[5] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.9.4/NEWS>`__ 
...
* ports: ca_root_nss 3.26, openssh 7.3p1 `[12] <https://www.openssh.com/txt/release-7.3>`__ 
...
* ports: libressl 2.3.7 `[3] <https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.3.7-relnotes.txt>`__ 
...
* ports: suricata 3.1.1 `[1] <https://suricata-ids.org/2016/07/13/suricata-3-1-1-released/>`__ , php 5.6.24 `[2] <https://www.php.net/ChangeLog-5.php#5.6.24>`__ 
...
* ports: python 2.7.12 `[1] <https://hg.python.org/cpython/raw-file/v2.7.12/Misc/NEWS>`__ , squid 3.5.20 `[2] <http://ftp.meisei-u.ac.jp/mirror/squid/squid-3.5-ChangeLog.txt>`__ , pkg 1.8.7 `[3] <https://github.com/freebsd/freebsd-ports/commit/06593f2394>`__ , hyperscan 4.2.0 `[4] <https://github.com/intel/hyperscan/releases/tag/v4.2.0>`__ 
