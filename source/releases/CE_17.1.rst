...
* ports: php 7.0.21 `[2] <https://www.php.net/ChangeLog-7.php#7.0.21>`__ 
...
* ports: openvpn 2.4.3 `[3] <https://github.com/OpenVPN/openvpn/blob/v2.4.3/Changes.rst>`__ 
* ports: sudo 1.8.20p2 `[4] <https://www.sudo.ws/releases/legacy/#1.8.20p2>`__ 
* ports: dnsmasq 2.77 `[5] <https://www.thekelleys.org.uk/dnsmasq/CHANGELOG>`__ 
* ports: openldap 2.4.45 `[6] <https://www.openldap.org/software/release/changes_lts.html>`__ 
* ports: php 7.0.20 `[7] <https://www.php.net/ChangeLog-7.php#7.0.20>`__ 
...
* ports: openvpn 2.3.15 `[2] <https://github.com/OpenVPN/openvpn/blob/v2.3.15/Changes.rst>`__ 
* ports: php 7.0.19 `[3] <https://www.php.net/ChangeLog-7.php#7.0.19>`__ 
* ports: squid 3.5.25 `[4] <http://ftp.meisei-u.ac.jp/mirror/squid/squid-3.5.25-RELEASENOTES.html>`__ 
* ports: sudo 1.8.20 `[5] <https://www.sudo.ws/releases/legacy/#1.8.20>`__ 
...
* ports: phalcon 3.1.2 `[1] <https://github.com/phalcon/cphalcon/releases/tag/v3.1.2>`__ 
...
* ports: hyperscan 4.4.1 `[6] <https://github.com/intel/hyperscan/releases/tag/v4.4.1>`__ 
...
* ports: php 7.0.18 `[10] <https://www.php.net/ChangeLog-7.php#7.0.18>`__ 
...
* plugins: Let's Encrypt 1.4 `[1] <https://github.com/opnsense/plugins/pull/91>`__  `[2] <https://github.com/opnsense/plugins/pull/103>`__  (contributed by Felix Kling and Frank Wall)
...
* ports: php 7.0.17 `[6] <https://www.php.net/ChangeLog-7.php#7.0.17>`__ 
...
* firmware: add mirror via Universidad Pontificia Bolivariana `[1] <https://www.upb.edu.co/>`__  (Medellin, CO)
* firmware: add mirror via DMC Networks `[2] <http://dmcnet.net/>`__  (Lincoln NE, US)
...
* plugins: Let's Encrypt version 1.2 `[3] <https://github.com/opnsense/plugins/pull/76>`__  (contributed by Frank Wall)
...
* ports: php 7.0.16 `[10] <https://www.php.net/ChangeLog-7.php#7.0.16>`__ 
...
* ports: hyperscan 4.4.0 `[5] <https://github.com/intel/hyperscan/releases/tag/v4.4.0>`__ 
...
* ports: libevent 2.1.8 `[7] <https://github.com/libevent/libevent/releases/tag/release-2.1.8-stable>`__ 
...
* ports: php 7.0.15 `[3] <https://www.php.net/ChangeLog-7.php#7.0.15>`__ 
...
* Due to a Python 2.7.13 incompatibility the NetFlow connector may not work.  A workaround is to revert to the Python 2.7.12 release.  See the forum for details `[1] <https://forum.opnsense.org/index.php?topic=4235.0>`__ .
