...
* ports: php 7.1.25 `[10] <https://www.php.net/ChangeLog-7.php#7.1.25>`__ 
...
* ports: php 7.1.24 `[9] <https://www.php.net/ChangeLog-7.php#7.1.24>`__ 
* ports: pkg minor upstream fixes
* ports: sudo 1.8.26 `[10] <https://www.sudo.ws/releases/legacy/#1.8.26>`__ 
...
* ports: krb5 1.16.2 `[3] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: PHP 7.1.23 `[3] <https://www.php.net/ChangeLog-7.php#7.1.23>`__ 
...
* ports: php 7.1.22 `[2] <https://www.php.net/ChangeLog-7.php#7.1.22>`__ 
...
* ports: sudo 1.8.25p1 `[5] <https://www.sudo.ws/releases/legacy/#1.8.25p1>`__ 
...
* src: L1 terminal fault kernel information disclosure `[2] <https://www.freebsd.org/security/advisories/FreeBSD-SA-18:09.l1tf.asc>`__ 
...
* ports: php 7.1.21 `[7] <https://www.php.net/ChangeLog-7.php#7.1.21>`__ 
* ports: sudo 1.8.24 `[8] <https://www.sudo.ws/releases/legacy/#1.8.24>`__ 
...
* ports: php 7.1.20 `[2] <https://www.php.net/ChangeLog-7.php#7.1.20>`__ 
