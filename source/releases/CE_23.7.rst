...
* ports: sudo 1.9.15p5 `[7] <https://www.sudo.ws/releases/stable/#1.9.15p5>`__ 
...
* ports: sudo 1.9.15p4 `[9] <https://www.sudo.ws/releases/stable/#1.9.15p4>`__ 
...
* ports: openvpn 2.6.8 `[3] <https://github.com/OpenVPN/openvpn/blob/v2.6.8/Changes.rst>`__ 
* ports: sqlite 3.44.0 `[4] <https://sqlite.org/releaselog/3_44_0.html>`__ 
* ports: sudo 1.9.15p2 `[5] <https://www.sudo.ws/releases/stable/#1.9.15p2>`__ 
...
* ports: sudo 1.9.15 `[12] <https://www.sudo.ws/releases/stable/#1.9.15>`__ 
...
* ports: krb5 1.21.2 `[3] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
* ports: openldap 2.6.6 `[4] <https://www.openldap.org/software/release/changes_lts.html>`__ 
* ports: openvpn 2.6.6 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.6.6/Changes.rst>`__ 
...
* ports: krb5 1.21.1 `[9] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: sudo 1.9.14p3 `[13] <https://www.sudo.ws/releases/stable/#1.9.14p3>`__ 
...
* ports: krb5 1.21.1 `[8] <https://web.mit.edu/kerberos/krb5-$1/>`__ 
...
* ports: py-duckdb 0.8.1
* ports: py-vici 5.9.11
* ports: sudo 1.9.14p2 `[11] <https://www.sudo.ws/releases/stable/#1.9.14p2>`__ 
* ports: suricata now enables Netmap V14 API
