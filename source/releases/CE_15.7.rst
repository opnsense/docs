...
* ports: suricata 2.0.11 `[2] <http://suricata-ids.org/2015/12/21/suricata-2-0-11-available/>`__ 
* ports: dhcp6 20080615_5 `[3] <https://github.com/freebsd/freebsd-ports/commit/7f6883d1dd>`__ 
* ports: lighttpd 1.4.39 `[4] <https://www.lighttpd.net/2016/1/2/1.4.39/>`__ 
* ports: syslogd 10.2
* ports: mpd 5.8 `[5] <http://mpd.sourceforge.net/doc5/mpd4.html#4>`__ 
* ports: ca_root_nss 3.21
* ports: dnsmasq 2.75_1 `[6] <https://reviews.freebsd.org/D4813>`__ 
* ports: ntp 4.2.8p5 `[7] <http://support.ntp.org/bin/view/Main/SecurityNotice#Recent_Vulnerabilities>`__ 
* ports: php 5.6.17 `[8] <https://www.php.net/ChangeLog-5.php#5.6.17>`__ 
* ports: python 2.7.11_1 `[9] <https://bugs.python.org/issue20397>`__ 
* ports: miniupnpd 1.9.20151212
* ports: openvpn 2.3.10 `[10] <https://github.com/OpenVPN/openvpn/blob/v2.3.10/Changes.rst>`__ 
...
* ports: bind 9.10.3-P2 `[1] <https://kb.isc.org/article/AA-01328/0/BIND-9.10.3-P2-Release-Notes.html>`__ 
* ports: python 2.7.11 `[2] <https://hg.python.org/cpython/raw-file/53d30ab403f1/Misc/NEWS>`__ 
* ports: openvpn 2.3.9 `[3] <https://github.com/OpenVPN/openvpn/blob/v2.3.9/Changes.rst>`__ 
...
* ports: openldap 2.4.43 `[4] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: libxml 2.9.3 `[6] <https://gitlab.gnome.org/GNOME/libxml2/-/blob/v2.9.3/NEWS>`__ 
...
* ports: libressl 2.2.3 `[4] <https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.2.3-relnotes.txt>`__ , bind 9.10.2P4 `[5] <https://kb.isc.org/article/AA-01301/81/BIND-9.10.2-P4-Release-Notes.html>`__ , openldap 2.4.42 `[6] <https://www.openldap.org/software/release/changes_lts.html>`__ 
...
* ports: dnsmasq 2.75 `[3] <https://www.thekelleys.org.uk/dnsmasq/CHANGELOG>`__ 
* ports: squid 3.5.7 `[4] <http://ftp.meisei-u.ac.jp/mirror/squid/squid-3.5-ChangeLog.txt>`__ 
* ports: openvpn 2.3.8 `[5] <https://github.com/OpenVPN/openvpn/blob/v2.3.8/ChangeLog>`__ 
* ports: libressl 2.2.2 `[6] <https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.2.2-relnotes.txt>`__ 
* ports: lighttpd 1.4.36 `[7] <https://www.lighttpd.net/2015/7/26/1.4.36/>`__ 
* ports: php 5.6.12 `[8] <https://www.php.net/ChangeLog-5.php#5.6.12>`__ 
* ports: pcre 8.37_3 `[9] <https://github.com/freebsd/freebsd-ports/commit/1b0e3ce910b727>`__ 
* ports: pkg 1.5.6 `[10] <https://github.com/freebsd/freebsd-ports/commit/1a100a88a92d4>`__ 
* ports: expat 2.1.0_3 `[11] <https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-1283>`__ 
